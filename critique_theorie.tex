...
En se basant sur son discours, on peut diagnostiquer Christine Thiran comme \og Agent de changement \fg{}, de part sa mission d'accompagner la fusion du groupe Mestdagh avec des magasins Carrefour, mais aussi comme \og{} Championne des employés \fg{} \textbf{verifier que c'est bien ca que l'on dit plus haut}. \newline
...
La première limite de ce modèle est donc le manque d'une pluralité des fonctions pour un même DRH. En réalité, on sait que nous avons hérité de certaines pratiques de chacun des rôles du modèle d'Ulrich \footnote{TO DO}. Et donc il est tout à fait possible qu'aujourd'hui un responsable des ressources humaines assume plusieurs fonctions en même temps dans son métier. \\
%TO DO : Ajout footNote avec fichier Historique GRH, pour les pratiques héritées. 


% 2. Manque de temporalité/dynamisme
...
%TO DO : Une source serait bien pour montrer que les entreprises se rendes compte de l'importance de leurs employés
%(Léo)--> En effet ! 
