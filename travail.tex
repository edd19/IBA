...
La première est Christine Thiran qui travaille actuellement comme directrice des ressources humaines pour le groupe Mestdagh. Durant son parcours, elle a occupé le poste de DRH chez Belgacom \todo[inline]{Dire le nombre exact d'années ou supprimer} durant X années  où elle a notamment été responsable d'un plan de restructuration concernant 4500 personnes \cite{planBEST}.
\todo[inline]{http://www.hrsquare.be/fr/nominations/1694/christine-thiran-drh-du-groupe-mestdagh Elle entre chez belgacom en 1994 et quitte en 2004. Donc 10 ans.}
