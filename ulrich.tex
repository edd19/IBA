...
%Partenaire stratégique car il doit choisir le changement (decentralisation) + optimalisation et on peut supposer que c'est dans tous les départements donc RH aussi 
